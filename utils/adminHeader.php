    ...
    <nav class="navbar">
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="sponsors.php"><strong>Sponsors</strong></a></li>
                <li><a href="participants.php"><strong>Participants</strong></a></li> <!-- New "Participants" item -->
                <li class="btnlogout">
                    <a class="btn btn-default navbar-btn" href="index.php">Logout <span class="glyphicon glyphicon-log-out"></span></a>
                </li>
            </ul>
        </div><!--container div-->
    </nav>
